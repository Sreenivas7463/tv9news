...
export default function PostPage({post}){
    return (
        ...
        <meta property="og:image" content={post['_embedded']['wp:featuredmedia'][0].media_details.sizes.large['source_url']} />
        ...
        <meta property="twitter:image" content={post['_embedded']['wp:featuredmedia'][0].media_details.sizes.large['source_url']} />
      </Head>
