...
function Page({ data }) {
    ...
    return (
        ...
        <meta property="og:image" content={data[0]['_embedded']['wp:featuredmedia'][0].media_details.sizes.large['source_url']} />
        ...
        <meta property="twitter:image" content={data[0]['_embedded']['wp:featuredmedia'][0].media_details.sizes.large['source_url']} />
  ...
  export async function getServerSideProps(context) {
    ...
    const response = await fetch(`https://tv9telugu.com/wp-json/wp/v2/posts?_embed&slug=${slug}`)
